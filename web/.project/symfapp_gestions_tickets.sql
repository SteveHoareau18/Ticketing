...
INSERT INTO `mail_configuration` (`id`, `login`, `password`, `smtp_address`, `smtp_port`, `smtp_tls`, `cc_address`,
                                  `subject`)
VALUES (1, 'stevehoareau18.dev@gmail.com', 'vQ3mm0PxgQTQtLg', 'smtp.freesmtpservers.com', '25', 1,
        'steve.hoareau1@gmail.com', 'PLATEFORME TICKETING');
...
INSERT INTO `relance` (`id`, `treatment_id`, `user_id`, `reason`, `email`, `reopen`, `relance_date`)
VALUES (3, 12, 1, 'ce n\'est pas la bonne version...', NULL, 1, '2023-09-04 13:05:57');
...
INSERT INTO `ticket` (`id`, `service_id`, `creator_id`, `create_date`, `problem`, `result`, `result_date`, `transfered`)
VALUES (3, 3, 2, '2023-08-31 10:58:08', 'Le client à besoin d\'une mise à jour office', 'mis à jour',
        '2023-09-04 13:08:53', 0),
       (4, 3, 2, '2023-08-31 13:17:32', 'Le client à besoin d\'un devis', NULL, NULL, 0),
       (5, 1, 5, '2023-09-04 15:08:12', 'Faire un point sur le projet Gestion d\'intervention', 'Module ajouté',
        '2023-09-07 11:43:22', 0),
       (6, 1, 5, '2023-09-04 15:29:04', 'Le client a besoin d\'un devis pour la gestion de sa page facebook', NULL,
        NULL, 0),
       ...
       (9, 1, 3, '2023-09-07 11:16:43', 'Le client a besoin d\'une application de gestion d\'intervention', NULL, NULL,
        0),
       (10, 1, 3, '2023-09-07 11:17:15', 'Le client a besoin de renseignement pour le prix total du projet', NULL, NULL,
        0),
...
INSERT INTO `treatment` (`id`, `ticket_id`, `caterer_id`, `observations`, `status`, `start_date`, `end_date`)
VALUES (9, 3, 2, 'Le client n\'est pas en contrat', 'RELAYÉ', '2023-08-31 14:54:27', '2023-08-31 14:55:41'),
...
INSERT INTO `user` (`id`, `service_id`, `email`, `username`, `roles`, `password`, `name`, `firstname`, `active`)
VALUES (1, 4, 'steve.hoareau1@gmail.com', 'hsteve', '[\"ROLE_ADMIN\"]',
        '$2y$13$8nTibHJVfx/HMWieA2AOrOWiphxNFuh4WuFJLplQzaTJRaQjkXM/a', 'HOAREAU', 'Steve', 1),
       (2, 1, 'john.doe@gmail.com', 'jdoe', '[\"ROLE_USER\"]',
        '$2y$13$mDIrZZjKFNIo3Wv.8qvhs.0A0dN4INnwRmmH9aGQC8HVKiW425BBO', 'John', 'Doe', 1),
       (3, 2, 'maxime.clain@gmail.com', 'mclain', '[\"ROLE_USER\"]',
        '$2y$13$1JzmK1GRWESFaoCeh3wEhe1bTCPknyGzCXALoEZyvsA0We0LMnErq', 'Clain', 'Maxime', 1),
       (4, 1, 'tony.ranguin@gmail.com', 'tranguin', '[\"ROLE_USER\"]',
        '$2y$13$/Gu77M3TuK53uoiBxHAjVOzRZLRnvq8GsLf7HfVYnRG92RXAKrT56', 'Ranguin', 'Tony', 1),
       (5, 3, 'kotou.boina@gmail.com', 'kboina', '[\"ROLE_USER\"]',
        '$2y$13$ToxjxzFxUgkn0aI90BSQuuP0mQS0dfiohEpE3g0i6ASg4FIcTCPCO', 'Boina', 'Kotou', 1);
